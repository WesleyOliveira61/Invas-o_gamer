...
class Button:
    def __init__(self, ai_settings, screen, msg) -> None:
        ...
        # Constrói o objeto rect sdo botão e o centraliza
        self.rect = pygame.Rect(0, 0, self.width, self.height)
        self.rect.center = self.screen_rect.center

        # A menssagem do botão deve ser preparada apenas umaa vez
        self.prep_msg(msg)

    def prep_msg(self, msg):
        """Transforma msg em imagem renderizada o e centraliza o texto
        no botão"""
